...
| --- | --- | --- |
| **Free file size** | Unlimited (peer-to-peer) | 2 GB fast lane, larger files queued |
| **Peak-hour queue** | None (P2P direct) | Yes for files over 2 GB |
| **Starting paid price** | $6/mo (Starter, yearly) | ~€5/mo (Team) |
| **End-to-end encryption** | Yes (Quick Transfers) | Yes |
| **No AI training on uploads** | Yes | Yes |
| **Third-party trackers on landing page** | None | Google Tag Manager |
| **Open source** | Yes | No |
| **Max file size (paid)** | 1 TB | Configurable |
| **Retention (paid)** | Up to 365 days | 30 days (Team), longer on Pro+ |
| **Custom branding** | Pro plan | Paid plans |
...
Ready to try? [Send your first file with Transfer.zip](/) — no signup, no queue.
